...
public class GlobalExceptionHandler {
    ...
    public AjaxResult handleNotPermissionException(NotPermissionException e, HttpServletRequest request) {
        ...
        return AjaxResult.error(HttpStatusEnum.FORBIDDEN.getCode(), "没有访问权限，请联系管理员授权");
    }
    ...
    public AjaxResult handleNotLoginException(NotLoginException e, HttpServletRequest request) {
        ...
        return AjaxResult.error(HttpStatusEnum.UNAUTHORIZED.getCode(), "认证失败，无法访问系统资源");
    }
    ...
    public AjaxResult handleIdTokenInvalidException(SameTokenInvalidException e, HttpServletRequest request) {
        String requestUri = request.getRequestURI();
    ...
    public AjaxResult handleUserException(LoginException e, HttpServletRequest request) {
