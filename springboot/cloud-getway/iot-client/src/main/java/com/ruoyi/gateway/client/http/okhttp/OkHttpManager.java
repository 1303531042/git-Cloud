package com.ruoyi.gateway.client.http.okhttp;

import com.ruoyi.gateway.client.http.*;
import okhttp3.*;
...
public class OkHttpManager implements HttpManager, InitializingBean {
    ...
    @Override
    public void get(HttpRequestMessage requestMessage, ClientHttpProtocol.HttpProtocolCall handle) {
        long timeout = requestMessage.getTimeout();
    ...
    @Override
    public void post(HttpRequestMessage requestMessage, ClientHttpProtocol.HttpProtocolCall handle) {
        long timeout = requestMessage.getTimeout();
    ...
    protected void httpAsyncCallback(ClientHttpProtocol.HttpProtocolCall handle, OkHttpClient okHttpClient, Request.Builder builder) {
