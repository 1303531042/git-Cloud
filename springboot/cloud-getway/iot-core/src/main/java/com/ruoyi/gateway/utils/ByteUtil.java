...
public class ByteUtil {
	...
	public static short bytesToShortOfReverse(byte[] bytes) {
		return ByteUtil.bytesToShortOfReverse(bytes, 0);
	}
	...
	public static int bytesToIntOfReverse(byte[] bytes) {
		return ByteUtil.bytesToIntOfReverse(bytes, 0);
	}
	...
	public static long bytesToUInt(byte[] bytes) {
		return ByteUtil.bytesToUInt(bytes, 0);
	}
	...
	public static long bytesToUIntOfReverse(byte[] bytes) {
		return ByteUtil.bytesToUIntOfReverse(bytes, 0);
	}
	...
	public static long bytesToLong(byte[] bytes) {
		return ByteUtil.bytesToLong(bytes, 0);
	}
	...
	public static long bytesToLongOfReverse(byte[] bytes) {
		return ByteUtil.bytesToLongOfReverse(bytes, 0);
	}
