...
import com.ruoyi.gateway.client.ClientHandleFactory;
import com.ruoyi.gateway.client.ClientProxyServerComponent;
import com.ruoyi.gateway.client.ClientProxyServerHandle;
import com.ruoyi.gateway.client.handle.ClientHandleBeanPostProcessor;
import com.ruoyi.gateway.codec.adapter.SocketMessageDecoderDelegation;
...
import com.ruoyi.gateway.server.codec.UdpServerProtocolEncoder;
import com.ruoyi.gateway.server.component.SocketServerComponent;
import com.ruoyi.gateway.server.component.TcpServerComponent;
import com.ruoyi.gateway.server.endpoints.ServerHealthWebsocketEndpoint;
import com.ruoyi.gateway.server.handle.EventManagerHandler;
import com.ruoyi.gateway.server.handle.ProtocolBusinessHandler;
import com.ruoyi.gateway.server.udp.UdpServerComponent;
import com.ruoyi.gateway.server.udp.impl.DefaultUdpConnectProperties;
import com.ruoyi.gateway.server.udp.impl.DefaultUdpServerComponent;
import com.ruoyi.gateway.server.websocket.impl.DefaultWebSocketServerComponent;
import com.ruoyi.gateway.server.websocket.impl.DefaultWebSocketServerProtocolHandle;
...
import static com.ruoyi.gateway.CoreConst.*;
...
public class IotServeBootstrap implements InitializingBean, BeanFactoryAware, ApplicationRunner {
    ...
    public IotServeBootstrap(ApplicationContext applicationContext, IotThreadManager threadManager, IotCoreProperties coreProperties) {
    ...
    public void run(ApplicationArguments args) throws Exception {
        try {
            ...
            logger.info("IOT服务端应用启动成功 启用组件数：{}", COMPONENT_FACTORY.size());
    ...
    public ServerProtocolHandleFactory deviceRequestBusinessFactory() {
        return BUSINESS_FACTORY = new ServerProtocolHandleFactory();
    }
    ...
    public ProtocolBusinessHandler businessHandler(ServerComponentFactory componentFactory
        ...
        return this.protocolHandler = new ProtocolBusinessHandler(componentFactory, handleFactory);
    }
    ...
    public ServerComponentFactory serverComponentFactory() {
        return COMPONENT_FACTORY = new ServerComponentFactory();
    }
    ...
    public DeviceProtocolEncoder deviceProtocolEncoder(ServerComponentFactory componentFactory) {
        return this.protocolEncoder = new DeviceProtocolEncoder(componentFactory);
    }
    ...
    public ServerTimeoutProtocolManager serverTimeoutProtocolManager(ServerProtocolHandleFactory handleFactory
            , ServerComponentFactory componentFactory, IotThreadManager threadManager) {
        ...
        return new ServerTimeoutProtocolManager(handleFactory, threadManager, storages);
    }
