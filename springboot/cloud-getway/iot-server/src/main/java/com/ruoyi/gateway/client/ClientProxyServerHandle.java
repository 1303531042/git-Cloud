...
import com.ruoyi.gateway.proxy.ProxyClientMessageHead;
...
public class ClientProxyServerHandle implements ServerProtocolHandle<ClientProxyServerProtocol> {
    ...
    public Object handle(ClientProxyServerProtocol protocol) {
        ...
        try {
             ...
             * @see ServerInitiativeProtocol#proxyClientHandle(Object) 等待设备响应后, 会主动在给客户端调用请求, 响应请求信息
             *
            ...
            if(returnValue instanceof ClientProxySync) {
                ...
                if(head.isWaiting()) {
                    /**
                     * @see ServerInitiativeProtocol#proxyClientHandle(Object)
                     */
