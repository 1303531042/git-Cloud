...
import com.ruoyi.gateway.event.ExceptionEvent;
import com.ruoyi.gateway.event.ExceptionEventListener;
    ...
    protected void channelRead0(ChannelHandlerContext ctx, UnParseBodyMessage msg) throws Exception {
        ...
        try {
            ...
            if(protocol instanceof HeartbeatProtocol) {
                ((HeartbeatProtocol) protocol).setServerComponent(serverComponent).exec(businessFactory);
                return;
            }
