package com.ruoyi.gateway.mqtt.simulation.enums;
 ...
 */
public enum MqttMethodEnum implements RequestEnum {
    ...
    MqttMethodEnum(String name, int code) {
        this.name = name;
        this.code = code;
    }
    ...
    public static MqttMethodEnum INSTANCE(int code) {
        switch (code) {
