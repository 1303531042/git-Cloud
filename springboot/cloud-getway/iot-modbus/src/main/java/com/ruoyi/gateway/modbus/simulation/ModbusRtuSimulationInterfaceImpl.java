 ...
 */
@Component("modbusRtu")
public class ModbusRtuSimulationInterfaceImpl extends AbstractGateWaySimulationInterface<ModbusMethodEnum, ModbusRtuForDtuCommonProtocol, ModbusRtuForDtuMessage> {


    private final String packageName = "com.ruoyi.gateway.modbus";

    public ModbusRtuSimulationInterfaceImpl() {
    }
