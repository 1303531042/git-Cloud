 ...
 */
@Repository
public interface DeviceMapper extends BaseMapperPlus<DeviceMapper, Device, Device>
{
    /**
     * 查询设备
     * 
    ...
    public List<ThingsModelValuesOutput> selectDeviceThingsModelValueBySerialNumbers(@Param("serialNumbers")List<String> serialNumbers);
